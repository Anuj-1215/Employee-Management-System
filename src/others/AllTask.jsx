...
const AllTask = () => {
  ...
  return (
    <div id='taskList' className='bg-[#1c1c1c] p-3 rounded mt-5 h-43'>
      ...
      <div id='taskList' className='h-[80%] overflow-auto'>
        ...
        return <div className=' border-2 border-emerald-300 mb-2 py-2 px-4 flex items-center justify-around rounded'>
